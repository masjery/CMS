...
<li class="tab grey">
<a href="#signup" class="black-text grey">Sign Up</a>
</li>
</ul>
</div>
...
<input type="submit" name="login" value="Login" class="btn grey">
</form>
</div>
</div>
...
<input type="submit" name="signup" class="btn grey" value="Sign Up">
</form>
</div>
</div>
